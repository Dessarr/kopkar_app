        ...
        <section id="loginAdmin" class="absolute top-0 left-0 w-full h-full flex transition-slide z-20 translate-x-0">
            <div class="w-1/2 bg-white flex items-center justify-center">
                <div
                    ...
                    <form class="px-4 md:px-8" id="loginAdminForm">
                        @csrf
                        <div class="mb-4">
                            <div
                                ...
                                <input type="text" name="username" id="usernameAdmin" placeholder="Username"
                                    value="{{ old('username') }}"
                        ...
                        <div class="mb-6">
                            <div
                                ...
                                <input type="password" name="password" id="passwordAdmin" placeholder="Password"
                                    class="w-full px-4 py-3 md:py-4 bg-transparent outline-none" required />
                            </div>
                        </div>
