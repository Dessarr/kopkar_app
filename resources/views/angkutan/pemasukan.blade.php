    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('angkutan.export.pdf.pemasukan', request()->query()) }}"
                ...
                <a href="{{ route('angkutan.export.excel.pemasukan', request()->query()) }}"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Untuk Kas</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ optional($tr->untukKas)->nama }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            Pendapatan Jasa Sewa Bus
                        </td>
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-sm text-gray-500">
                            Tidak ada data pemasukan angkutan
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-gray-900" id="modal-title">Tambah Pemasukan Angkutan</h3>
            ...
            <form id="transaksiForm" action="{{ route('angkutan.store.pemasukan') }}" method="POST" class="space-y-4">
                @csrf
                    <div>
...
<script>
    ...
    function openModal() {
        ...
        document.getElementById('modal-title').textContent = 'Tambah Pemasukan Angkutan';
        document.getElementById('transaksiForm').reset();
        document.getElementById('transaksiForm').action = '{{ route("angkutan.store.pemasukan") }}';
    }
