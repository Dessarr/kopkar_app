    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h3 class="font-bold text-gray-800 mb-4">Transaksi Terakhir</h3>
             <ul class="space-y-2 text-sm text-gray-600">
                <li class="flex items-center"><span class="w-3 h-3 rounded-full bg-green-500 mr-2"></span>Toserda: <span class="font-bold ml-auto">{{ number_format($anggota->transaksi_toserda ?? 0, 0, ',', '.') }}</span></li>
