...
<div class="px-1 justify-center flex flex-col">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Data Transaksi Pemasukan Kas</h1>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-4 border-b">
            <h2 class="text-lg font-semibold">Data Pemasukan</h2>
        </div>
            ...
            <table class="table-auto w-full border border-gray-300 text-center">
                ...
                <tbody>
                    ...
                    <tr class="text-sm align-middle">
                        ...
                        <td class="py-2 border">{{ $kas->kasTujuan->nama ?? '-' }}</td>
                        <td class="py-2 border">Rp{{ number_format($kas->debet, 0, ',', '.') }}</td>
