...
<body>
    <h2 class="text-center">LAPORAN TARGET & REALISASI</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($row['sisa_pokok']) }}</td>
                ...
                <td class="text-right">{{ number_format($row['biaya_adm']) }}</td>
                <td>{{ $row['bln_sudah_angsur'] }}</td>
                <td class="text-right">{{ number_format($row['total_bayar']) }}</td>
                <td class="text-right">{{ number_format($row['bunga_ags']) }}</td>
                <td class="text-right">{{ number_format($row['denda_rp']) }}</td>
                <td class="text-right">{{ number_format($row['total_bayar'] + $row['bunga_ags'] + $row['denda_rp']) }}</td>
