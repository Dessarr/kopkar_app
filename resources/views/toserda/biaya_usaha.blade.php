...
<div class="container">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-orange-100 border border-orange-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-orange-600">Total Biaya Usaha</p>
    ...
    <!-- Add Biaya Usaha Button -->
    <div class="mb-6">
        <button onclick="openModal()" class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500">
            <i class="fas fa-plus mr-2"></i>Add Biaya Usaha
        </button>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-800">Filter Biaya Usaha Toserda</h3>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                    <tr>
                        <td colspan="8" class="px-4 py-4 text-center text-gray-500">Belum ada data biaya usaha</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full">
            <div class="flex justify-between items-center p-6 border-b">
                <h3 class="text-lg font-semibold text-gray-900">Add Biaya Usaha Toserda</h3>
                <button onclick="closeModal()" class="text-gray-400 hover:text-gray-600">
                    <i class="fas fa-times"></i>
                </button>
        </div>

            <form id="addForm" action="{{ route('toserda.store.biaya-usaha') }}" method="POST" class="p-6">
            @csrf
                ...
                <div>
                    ...
                    <div>
                        ...
                        <select name="jns_trans" id="jns_trans" required
                            ...
                            <option value="122">122 - Beban Gaji Karyawan</option>
                            <option value="123">123 - Biaya Operasional</option>
                            <option value="124">124 - Bahan Habis Pakai</option>
                            <option value="152">152 - Biaya Lain-lain</option>
                    </select>
                </div>
...
<script>
    ...
    function exportData() {
        ...
        window.open("{{ route('toserda.biaya-usaha.export') }}?" + params.toString(), '_blank');
    }
