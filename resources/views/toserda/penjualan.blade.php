            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="anggota_id" id="anggota_id" required
                        ...
                        <option value="{{ $item->id }}">{{ $item->nama_anggota }} - {{ $item->no_ktp }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="barang_id" id="barang_id" required
                        ...
                        <option value="{{ $item->id }}" data-harga="{{ $item->harga_jual }}" data-stok="{{ $item->stok }}">
...
<script>
    document.getElementById('barang_id').addEventListener('change', function() {
        ...
        const hargaJual = selectedOption.dataset.harga;
