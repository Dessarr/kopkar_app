...
<head>
    ...
    <title>Laporan Pembelian Toserda</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>LAPORAN PEMBELIAN TOSERDA</h1>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <div class="info-value">Rp{{ number_format($totalPembelian, 0, ',', '.') }}</div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">{{ optional($tr->dariKas)->nama ?? '-' }}</td>
                <td class="text-left">
                    @php
                    $akunNames = [
                    '9' => 'Pembelian Barang',
                    '117' => 'Pembelian Bahan Baku',
                    '118' => 'Pembelian Perlengkapan',
                    '119' => 'Pembelian Peralatan',
                    '120' => 'Pembelian Lain-lain',
                    '121' => 'Pembelian Toserda'
                    ];
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center">Tidak ada data pembelian toserda</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
