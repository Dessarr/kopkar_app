...
<div class="px-1 justify-center flex flex-col">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('pinjaman.data_pinjaman.edit', $pinjaman->id) }}" 
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-900">{{ $pinjaman->jenis_pinjaman == '1' ? 'Biasa' : 'Barang' }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-900">{{ $pinjaman->status == '1' ? 'Aktif' : 'Terlaksana' }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-900">Rp {{ number_format($pinjaman->bunga_rp, 0, ',', '.') }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-900">Rp {{ number_format($pinjaman->jumlah + $pinjaman->biaya_adm, 0, ',', '.') }}</p>
            </div>
            <div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-yellow-50 p-4 rounded-lg">
                ...
                <p class="text-2xl font-bold text-yellow-900">{{ $pinjaman->lama_angsuran - $pinjaman->detail_angsuran->count() }} Bulan</p>
            </div>
            <div class="bg-purple-50 p-4 rounded-lg">
                <label class="block text-sm font-medium text-purple-700">Total Dibayar</label>
                <p class="text-2xl font-bold text-purple-900">Rp {{ number_format($pinjaman->detail_angsuran->sum('jumlah_bayar'), 0, ',', '.') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mt-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-900">{{ $pinjaman->update_data ? \Carbon\Carbon::parse($pinjaman->update_data)->format('d/m/Y H:i') : '-' }}</p>
            </div>
            <div>
