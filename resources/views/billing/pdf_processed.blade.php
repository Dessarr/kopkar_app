...
<body>
    <div class="header">
        <h1>LAPORAN PEMBAYARAN BILLING ANGGOTA KOPERASI</h1>
    ...
    <table>
        ...
        <tbody>
            @php 
                ...
                $no = 1;
            @endphp
            @forelse($dataBillingProcess as $item)
            <tr>
                ...
                <td class="text-center">{{ $item->tgl_bayar ? $item->tgl_bayar->format('d/m/Y') : '-' }}</td>
            </tr>
