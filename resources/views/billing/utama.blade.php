                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gray-50 text-gray-600 text-sm">
                            ...
                            <th class="px-4 py-3 border-b text-center">Total Tagihan Simpanan</th>
                    ...
                    <tbody class="divide-y">
                        ...
                        <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                            ...
                            <td class="px-4 py-3 text-right text-sm font-semibold">
                                {{ number_format($row->total_tagihan_simpanan ?? 0, 0, ',', '.') }}</td>
                            <td class="px-4 py-3 text-right text-sm">
                                {{ number_format($row->selisih ?? 0, 0, ',', '.') }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="10" class="px-4 py-3 text-center text-sm text-gray-500">Belum ada data Billing
                                Utama</td>
                        </tr>
                        @endforelse
                    </tbody>
