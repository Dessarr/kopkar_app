        ...
        <div class="p-6">
            ...
            <div class="mb-6 flex">
                <div class="flex space-x-2">
                    <form action="{{ route('billing.toserda.process_all') }}" method="POST">
                        @csrf
                        ...
                        <button type="submit"
                            ...
                            onclick="return confirm('Proses semua Billing Toserda bulan ini ke Billing Utama?')">
            ...
            <div class="mb-6">
                <form action="{{ route('billing.toserda') }}" method="GET"
                    ...
                    <tbody class="divide-y">
                        ...
                        <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                            ...
                            <td class="px-4 py-3 text-center">
                                <span class="px-3 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800">Belum
                                    Dibayar</span>
                            </td>
                            <td class="px-4 py-3 text-center text-sm font-medium">-</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="7" class="px-4 py-3 text-center text-sm text-gray-500">Tidak ada data billing
                                yang belum diproses
                            </td>
                        </tr>
                        @endforelse
