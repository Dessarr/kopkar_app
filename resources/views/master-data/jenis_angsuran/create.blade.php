...
@section('title', 'Tambah Jenis Angsuran')
...
<div class="px-1 justify-center flex flex-col">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('master-data.jenis_angsuran.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input type="number" id="ket" name="ket" value="{{ old('ket') }}" 
                ...
                <div class="mb-6">
                    ...
                    <select id="aktif" name="aktif" 
                        ...
                        <option value="T" {{ old('aktif') == 'T' ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                    @error('aktif')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <!-- Preview Kategori -->
                <div id="kategori-preview" class="mb-6 p-4 bg-gray-50 rounded-lg" style="display: none;">
                    <h4 class="text-sm font-medium text-gray-700 mb-2">Kategori Angsuran:</h4>
                    <div id="kategori-badge" class="inline-block"></div>
                </div>
            </div>
