...
<div class="px-1 justify-center flex flex-col">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Data Cabang</h1>
            <p class="text-sm text-gray-600 mt-1">Tambahkan data cabang koperasi baru</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('master-data.cabang.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">ID cabang otomatis terisi dan tidak dapat diubah</p>
                </div>
...
<!-- ID cabang otomatis terisi dan read-only, tidak perlu JavaScript -->
@endsection
