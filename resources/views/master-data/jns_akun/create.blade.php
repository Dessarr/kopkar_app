    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-gray-600">Tambah data jenis akun baru</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border">
            <form action="{{ route('master-data.jns_akun.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="pemasukan" 
                            ...
                            <option value="1" {{ old('pemasukan') == '1' ? 'selected' : '' }}>Ya</option>
                            <option value="0" {{ old('pemasukan') == '0' ? 'selected' : '' }}>Tidak</option>
                        </select>
                        @error('pemasukan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="pengeluaran" 
                                ...
                                required>
                            <option value="">Pilih Status</option>
                            <option value="1" {{ old('pengeluaran') == '1' ? 'selected' : '' }}>Ya</option>
                            <option value="0" {{ old('pengeluaran') == '0' ? 'selected' : '' }}>Tidak</option>
                        </select>
                        @error('pengeluaran')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
