...
@section('sub-title', 'Master Data Pengguna')
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $allDataPengguna->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $allDataPengguna->where('aktif', 'Y')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $allDataPengguna->where('aktif', 'N')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $allDataPengguna->where('level', 'admin')->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow mb-4">
        ...
        <div id="collapsible-content" class="space-y-4 p-4 border-t" style="display: none;">
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                <form method="GET" action="{{ route('master-data.data_pengguna.index') }}" class="flex flex-wrap gap-4 items-end">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('master-data.data_pengguna.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition-colors duration-200">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-gray-50 cursor-pointer transition-colors duration-200" 
                        onclick="window.location.href='{{ route('master-data.data_pengguna.show', $pengguna->id) }}'">
