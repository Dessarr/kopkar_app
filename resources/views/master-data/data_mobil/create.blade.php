...
<div class="px-1 justify-center flex flex-col">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Tambah Data Mobil</h1>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('master-data.data_mobil.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="pabrikan" name="pabrikan" value="{{ old('pabrikan') }}" 
                ...
                <div>
                    ...
                    <input type="text" id="no_rangka" name="no_rangka" value="{{ old('no_rangka') }}" 
                ...
                <div>
                    ...
                    <input type="text" id="no_mesin" name="no_mesin" value="{{ old('no_mesin') }}" 
                ...
                <div>
                    ...
                    <input type="text" id="no_bpkb" name="no_bpkb" value="{{ old('no_bpkb') }}" 
                ...
                <div>
                    ...
                    <input type="date" id="tgl_berlaku_stnk" name="tgl_berlaku_stnk" value="{{ old('tgl_berlaku_stnk') }}" 
                ...
                <div>
                    ...
                    <input type="text" id="file_pic" name="file_pic" value="{{ old('file_pic') }}" 
                ...
                <div>
                    ...
                    <select id="aktif" name="aktif" 
                        ...
                        <option value="N" {{ old('aktif') == 'N' ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                    @error('aktif')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
