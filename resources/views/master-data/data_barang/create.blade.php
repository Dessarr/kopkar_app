...
<div class="px-1 justify-center flex flex-col">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Tambah Data Barang</h1>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('master-data.data_barang.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nm_barang" name="nm_barang" value="{{ old('nm_barang') }}" 
                ...
                <div>
                    ...
                    <input type="number" id="jml_brg" name="jml_brg" value="{{ old('jml_brg') }}" 
                ...
                <div>
                    ...
                    <input type="text" id="id_cabang" name="id_cabang" value="{{ old('id_cabang') }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="ket" name="ket" rows="3" 
                              ...
                              placeholder="Masukkan keterangan barang">{{ old('ket') }}</textarea>
                    @error('ket')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
