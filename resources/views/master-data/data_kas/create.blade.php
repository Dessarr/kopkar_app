...
@section('sub-title', 'Tambah Data Kas Baru')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="tmpl_simpan" 
                        ...
                        <option value="Y" {{ old('tmpl_simpan') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_simpan') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    @error('tmpl_simpan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="tmpl_penarikan" 
                        ...
                        <option value="">Pilih</option>
                        <option value="Y" {{ old('tmpl_penarikan') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_penarikan') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="tmpl_pinjaman" 
                        ...
                        <option value="">Pilih</option>
                        <option value="Y" {{ old('tmpl_pinjaman') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_pinjaman') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    @error('tmpl_pinjaman')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="tmpl_bayar" 
                        ...
                        <option value="">Pilih</option>
                        <option value="Y" {{ old('tmpl_bayar') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_bayar') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    @error('tmpl_bayar')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="tmpl_pemasukan" 
                        ...
                        <option value="">Pilih</option>
                        <option value="Y" {{ old('tmpl_pemasukan') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_pemasukan') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="tmpl_pengeluaran" 
                        ...
                        <option value="">Pilih</option>
                        <option value="Y" {{ old('tmpl_pengeluaran') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_pengeluaran') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="tmpl_transfer" 
                        ...
                        <option value="">Pilih</option>
                        <option value="Y" {{ old('tmpl_transfer') == 'Y' ? 'selected' : '' }}>Ya</option>
                        <option value="T" {{ old('tmpl_transfer') == 'T' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    @error('tmpl_transfer')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
