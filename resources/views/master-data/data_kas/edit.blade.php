...
<div class="px-1 justify-center flex flex-col">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Edit konfigurasi kas: {{ $dataKas->nama }}</p>
        </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   name="tmpl_simpan" 
                                   value="Y"
                                   {{ old('tmpl_simpan', $dataKas->tmpl_simpan) == 'Y' ? 'checked' : '' }}
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   name="tmpl_penarikan" 
                                   value="Y"
                                   {{ old('tmpl_penarikan', $dataKas->tmpl_penarikan) == 'Y' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   name="tmpl_pinjaman" 
                                   value="Y"
                                   {{ old('tmpl_pinjaman', $dataKas->tmpl_pinjaman) == 'Y' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   name="tmpl_bayar" 
                                   value="Y"
                                   {{ old('tmpl_bayar', $dataKas->tmpl_bayar) == 'Y' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   name="tmpl_pemasukan" 
                                   value="Y"
                                   {{ old('tmpl_pemasukan', $dataKas->tmpl_pemasukan) == 'Y' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   value="Y"
                                   {{ old('tmpl_pengeluaran', $dataKas->tmpl_pengeluaran) == 'Y' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="checkbox" 
                                   ...
                                   name="tmpl_transfer" 
                                   value="Y"
                                   {{ old('tmpl_transfer', $dataKas->tmpl_transfer) == 'Y' ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        </div>
                ...
                <div class="bg-blue-50 p-4 rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-blue-600" id="totalFitur">{{ $dataKas->total_fitur_aktif }}</div>
                            <div class="text-sm text-gray-600">Total Fitur Aktif</div>
                        </div>
                        <div class="text-center">
                            <div class="text-lg font-semibold text-blue-600" id="kategoriKas">{{ $dataKas->kategori_kas }}</div>
                            <div class="text-sm text-gray-600">Kategori Kas</div>
                        </div>
                        <div class="text-center">
                            <div class="text-lg font-semibold text-blue-600" id="statusKas">{{ $dataKas->status_aktif_text }}</div>
