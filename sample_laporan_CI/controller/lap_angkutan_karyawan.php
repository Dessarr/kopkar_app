...
class Lap_angkutan_karyawan extends OperatorController {

public function __construct() {
		parent::__construct();	
		$this->load->helper('fungsi');
		$this->load->model('general_m');
		$this->load->model('lap_angkutan_karyawan_m');
	}	
	...
	public function index() {
		...
		$this->data['judul_sub'] 		= 'Bus Angkutan Karyawan';
		...
		$this->data['data_bus'] 		= $this->lap_angkutan_karyawan_m->get_data_bus();
		$this->data['jml_bus'] 			= $this->lap_angkutan_karyawan_m->get_jml_bus();
		$this->data['data_operasional'] = $this->lap_angkutan_karyawan_m->get_data_operasional();
		$this->data['jml_operasional'] 	= $this->lap_angkutan_karyawan_m->get_jml_operasional();
		$this->data['data_admin'] 		= $this->lap_angkutan_karyawan_m->get_data_admin();
		$this->data['jml_admin'] 		= $this->lap_angkutan_karyawan_m->get_jml_admin();
		$this->data['isi'] = $this->load->view('lap_angkutan_karyawan_list_v', $this->data, TRUE);
		$this->load->view('themes/layout_utama_v', $this->data);
	}

	function cetak() {
		$data_bus 			= $this->lap_angkutan_karyawan_m->get_data_bus();
		$jml_bus 			= $this->lap_angkutan_karyawan_m->get_jml_bus();
		$jml_bus_tahun 		= $this->lap_angkutan_karyawan_m->get_jml_bus_tahun();
		$jml_bus_tahun_pajak= $this->lap_angkutan_karyawan_m->get_jml_bus_tahun_pajak();
		
		$data_operasional 	= $this->lap_angkutan_karyawan_m->get_data_operasional();
		$jml_operasional 	= $this->lap_angkutan_karyawan_m->get_jml_operasional();
		$jml_operasional_tahun 		= $this->lap_angkutan_karyawan_m->get_jml_operasional_tahun();

		$data_admin 		= $this->lap_angkutan_karyawan_m->get_data_admin();
		$jml_admin 			= $this->lap_angkutan_karyawan_m->get_jml_admin();
		$jml_admin_tahun 	= $this->lap_angkutan_karyawan_m->get_jml_admin_tahun();
     ...
     $html = '
		...
		$pdf->nsi_html($html);
		//ob_end_clean();
		$pdf->Output('lap_angkutan_karyawan'.date('Ymd_His') . '.pdf', 'I');
	} 
}