...
class Transfer_kas extends OperatorController {
	...
	function ajax_list() {
		...
		$data   = $this->transfer_m->get_data_transaksi_ajax($id_cab,$offset,$limit,$search,$sort,$order);
		$i	= 0;
		$rows   = array(); 
	...
	function cetak_laporan() {
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="1" border-collapse= "collapse">
			<tr class="header_kolom">
				...
				<th class="h_tengah" style="width:8%;"> Dari Kas </th>
				<th class="h_tengah" style="width:8%;"> Untuk Kas  </th>
