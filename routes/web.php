...
// Public Print Routes (tidak memerlukan authentication)
...
Route::middleware(['auth:admin'])->group(function () { 
    ...
    // Jenis Simpanan
    Route::get('/master-data/jns_simpan', [JnsSimpanController::class, 'index'])->name('master-data.jns_simpan.index');
    Route::get('/master-data/jns_simpan/create', [JnsSimpanController::class, 'create'])->name('master-data.jns_simpan.create');
    Route::post('/master-data/jns_simpan', [JnsSimpanController::class, 'store'])->name('master-data.jns_simpan.store');
    ...
    Route::get('/master-data/jns_simpan/{id}', [JnsSimpanController::class, 'show'])->name('master-data.jns_simpan.show');
    Route::get('/master-data/jns_simpan/{id}/edit', [JnsSimpanController::class, 'edit'])->name('master-data.jns_simpan.edit');
    Route::put('/master-data/jns_simpan/{id}', [JnsSimpanController::class, 'update'])->name('master-data.jns_simpan.update');
    Route::delete('/master-data/jns_simpan/{id}', [JnsSimpanController::class, 'destroy'])->name('master-data.jns_simpan.destroy');
    // Data Pengguna
    Route::get('/master-data/data_pengguna', [DtaPenggunaController::class, 'index'])->name('master-data.data_pengguna.index');
    Route::get('/master-data/data_pengguna/create', [DtaPenggunaController::class, 'create'])->name('master-data.data_pengguna.create');
    Route::post('/master-data/data_pengguna', [DtaPenggunaController::class, 'store'])->name('master-data.data_pengguna.store');
    ...
    Route::get('/master-data/data_pengguna/{id}', [DtaPenggunaController::class, 'show'])->name('master-data.data_pengguna.show');
    Route::get('/master-data/data_pengguna/{id}/edit', [DtaPenggunaController::class, 'edit'])->name('master-data.data_pengguna.edit');
    Route::put('/master-data/data_pengguna/{id}', [DtaPenggunaController::class, 'update'])->name('master-data.data_pengguna.update');
    Route::delete('/master-data/data_pengguna/{id}', [DtaPenggunaController::class, 'destroy'])->name('master-data.data_pengguna.destroy');
    // Data Barang
    Route::get('/master-data/data_barang', [DtaBarangController::class, 'index'])->name('master-data.data_barang.index');
    Route::get('/master-data/data_barang/create', [DtaBarangController::class, 'create'])->name('master-data.data_barang.create');
    Route::post('/master-data/data_barang', [DtaBarangController::class, 'store'])->name('master-data.data_barang.store');
    ...
    Route::get('/master-data/data_barang/print', [DtaBarangController::class, 'print'])->name('master-data.data_barang.print');
    Route::get('/master-data/data_barang/{id}', [DtaBarangController::class, 'show'])->name('master-data.data_barang.show');
    Route::get('/master-data/data_barang/{id}/edit', [DtaBarangController::class, 'edit'])->name('master-data.data_barang.edit');
    Route::put('/master-data/data_barang/{id}', [DtaBarangController::class, 'update'])->name('master-data.data_barang.update');
    Route::delete('/master-data/data_barang/{id}', [DtaBarangController::class, 'destroy'])->name('master-data.data_barang.destroy');
    // Data Mobil
    Route::get('/master-data/data_mobil', [DtaMobilController::class, 'index'])->name('master-data.data_mobil.index');
    Route::get('/master-data/data_mobil/create', [DtaMobilController::class, 'create'])->name('master-data.data_mobil.create');
    Route::post('/master-data/data_mobil', [DtaMobilController::class, 'store'])->name('master-data.data_mobil.store');
    ...
    Route::get('/master-data/data_mobil/{id}', [DtaMobilController::class, 'show'])->name('master-data.data_mobil.show');
    Route::get('/master-data/data_mobil/{id}/edit', [DtaMobilController::class, 'edit'])->name('master-data.data_mobil.edit');
    Route::put('/master-data/data_mobil/{id}', [DtaMobilController::class, 'update'])->name('master-data.data_mobil.update');
    Route::delete('/master-data/data_mobil/{id}', [DtaMobilController::class, 'destroy'])->name('master-data.data_mobil.destroy');
    // Jenis Angsuran
    Route::resource('master-data/jenis_angsuran', JnsAngusuranController::class)->names([
        'index' => 'master-data.jenis_angsuran.index',
    ...
    Route::get('/master-data/data_anggota',[DtaAnggotaController::class,'index'])->name('master-data.data_anggota.index');
    ...
    Route::resource('master-data/data_kas', DtaKasController::class)->names([
        'index' => 'master-data.data_kas.index',
