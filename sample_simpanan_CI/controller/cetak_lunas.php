...
function cetak($id) {
    $angsuran = $this->angsuran_m->get_data_pembayaran_by_id($id);
        ...
        $html .= ''.$pdf->nsi_box($text ='<table width="100%">
            ...
            $bunga = $this->general_m->get_jml_bunga($row->pinjam_id);
            $adm = $this->general_m->get_jml_adm($row->pinjam_id);
            ...
            $sisa_bayar = $pinjaman->sisa_pokok;
            $total_bung = $bunga->total_bunga;
       ...
       $html.='<table width="100%">   
               <tr>
                   ...
                   <td width="2%"> :</td>
                   <td width="35%"> '.'TPJ'.sprintf('%05d', $pinjaman->id).'</td>
               </tr>
               <tr>
        ...
        $html .='<table width="100%">
                    ...
                    <tr>
                        <td> Total Bunga</td>
                        <td> : Rp. </td>
                        <td class="h_kanan"> '.number_format(nsi_round($total_bung)).'</td>
                    </tr>
                    <tr>
                        <td> Total Biaya Adm</td>
                        <td> : Rp. </td>
                        <td class="h_kanan"> '.number_format(nsi_round($adm->total_adm)).'</td>
                    </tr>
                    <tr>
                        <td> Total</td>
                        <td> : Rp. </td>
                        <td class="h_kanan"> '.number_format($tagihan + $jml_denda + $total_bung + $adm->total_adm).'</td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td> Sudah Dibayar</td>
